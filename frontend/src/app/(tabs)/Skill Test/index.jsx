    ...
    <View className="bg-white h-screen">
      ...
      <ScrollView contentContainerStyle={styles.scrollableSection}>
        ...
        <Pressable style={styles.card} onPress={() => {}}>
          ...
          <TouchableOpacity onPress={() => router.push("/Skill Test/questionPageCmz")} className="w-4/6 ml-auto mr-2 mt-14">
              <View className="bg-[#2E6E8E] py-2.5 rounded-lg">
                <Text className="text-md text-center text-white font-semibold">
                  Attempt Quiz
                </Text>
        ...
        <Pressable style={styles.card} onPress={() => {}}>
          ...
          <TouchableOpacity onPress={() => router.push("/Skill Test/questionPageBio")} className="w-4/6 ml-auto mr-2 mt-14">
              <View className="bg-[#2E6E8E] py-2.5 rounded-lg">
                <Text className="text-md text-center text-white font-semibold">
                  Attempt Quiz
                </Text>
        ...
        <Pressable style={styles.card} onPress={() => {}}>
          ...
          <TouchableOpacity onPress={() => router.push("/Skill Test/questionPageArt")} className="w-4/6 ml-auto mr-2 mt-14">
              <View className="bg-[#2E6E8E] py-2.5 rounded-lg">
                <Text className="text-md text-center text-white font-semibold">
                  Attempt Quiz
                </Text>
        ...
        <Pressable style={styles.card} onPress={() => {}}>
          ...
          <TouchableOpacity onPress={() => router.push("/Skill Test/questionPagetechnology")} className="w-4/6 ml-auto mr-2 mt-14">
              <View className="bg-[#2E6E8E] py-2.5 rounded-lg">
                <Text className="text-md text-center text-white font-semibold">
                  Attempt Quiz
                </Text>
