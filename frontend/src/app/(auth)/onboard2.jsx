  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 justify-center items-center px-6">
        ...
        <Text className="text-[27px] text-[#353333] font-semibold mt-4 text-center" style={{fontFamily: 'serif'}} >Welcome to AL Path Finder!</Text>
      ...
      <View className="flex-col items-center mb-10">
        <Text className="text-center text-[#908E8E] font-semibold mb-2 text-xl">Tap to learn more...</Text>
